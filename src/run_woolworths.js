...
const deals = await fetchWoolworths({ limit: MAX_POSTS * 2 });
...
for (const d of deals) {
  ...
  const url = affiliateUrl("WOOLWORTHS", d.url);
  ...
  const caption = formatDealCard({
    ...
    hashtags: ["#TopDeals", "#Woolworths", "#Today"]
  });
...
console.log(`✅ Posted woolworths: ${posted}`);
